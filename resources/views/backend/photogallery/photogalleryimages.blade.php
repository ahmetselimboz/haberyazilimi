...
@section('custom_css')
    ...
    <style>
        ...
        .getimagesclass > img {max-height:150px;width: 100%}
    </style>
@endsection
                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <div class="box-controls pull-right">
                            <div class="btn-group">
                                <a href="{{ route('photogallery.edit', $photogallery->id) }}" type="button" class="btn btn-success btn-sm"><i class="fa fa-undo"></i> Galeri Detayına Dön </a>
                            </div>
                        </div>
                    </div>
                    <!-- /.box-header -->
                    ...
                    <div class="row mx-2" id="sortable">
                        ...
                        @foreach($getimages as $getimage)
                            <div class="ui-state-default col-md-3 getimagesclass my-2 imgrow{{ $getimage->id }}" data-id="{{ $getimage->id }}">
                    ...
                    <div id="actions" class="row">
                        <div class="col-lg-7">
                            ...
                            <a href="{{ route('photogalleryimages', $photogallery->id) }}" class="btn btn-primary "><i class="fa fa-refresh"></i><span> Sayfayı Yenile</span></a>
...
@section('custom_js')
    ...
    <script>
        ...
        var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
            url: "{{ route('photogalleryimagespost', $photogallery->id) }}", // Set the url
            thumbnailWidth: 80,
            thumbnailHeight: 80,
            parallelUploads: 20,
        ...
        $('.imageupdatebutton').click(function (){
            ...
            $.ajax({
                ...
                url: "{{ route('photogalleryimageupdateNotID') }}",
                type:"POST",
        ...
        $('.imagedeletebutton').click(function (){
            ...
            $.ajax({
                url: "{{ route('photogalleryimagedeleteNotID') }}",
                type:"POST",
                ...
                $("#sortable").sortable({
                    stop: function( event, ui ) {
                        $( "#sortable .ui-state-default" ).each(function( index ) {
                            ...
                            $.ajax({
                                url: "{{ route('photogalleryimagesortby') }}",
                                type:"POST",

            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Resmi İlanlar Çöp Kutusu</h4>
                            ...
                            <table class="table table-hover">
                                ...
                                @foreach($clsfads as $clsfad)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="clearfix">
                                                <a href="{{ route('official_advert.restore', $clsfad->id) }}" type="button" class="waves-effect waves-light btn btn-secondary btn-sm pull-left" data-bs-toggle="tooltip" data-bs-placement="top" title="Geri getir"><i class="fa fa-undo"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach

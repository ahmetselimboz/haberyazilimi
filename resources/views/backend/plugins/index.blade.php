...
@section('title', 'Mevcut Eklentiler')
...
@section('content')
 @if (\Illuminate\Support\Facades\Storage::disk('public')->exists('installed_plugins.json'))
    @php 
        $plugins = \Illuminate\Support\Facades\Storage::disk('public')->json('installed_plugins.json'); 
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-md">
        <div class="modal-content rounded-3">
                ...
                <div class="mb-2 px-4">
                        <small class="text-muted">
                            <strong>Versiyon:</strong> <span class="modal-version"></span><br>
                             <strong>Yazar:</strong> <span  class="modal-author"></span>
                        </small>
                </div>
            </div>
            <div class="modal-footer d-flex justify-content-center">
                    ...
                    <!--<a href="http://musteri.medyayazilimlari.com" class="btn btn-sm py-1 btn-info d-flex align-items-center">-->
...
<section class="content">
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Mevcut Eklentiler</h4>
                        <div class="box-controls pull-right">
                            <div class="btn-group">
                                <a href="{{ route('plugin.market') }}" type="button" class="btn btn-success btn-sm"><i class="fa fa-archive me-1"></i>Eklenti Mağazası</a>
    ...
    <tr>
        <td>{{ $plugin['name'] }}</td>
        <td>{{ \Illuminate\Support\Str::limit(strip_tags($plugin['description']), 40) }}</td>
...
@empty
    <tr>
        <td colspan="5" class="text-center text-muted">
            <i class="fa fa-puzzle-piece fa-2x d-block mb-2"></i>
            Henüz yüklü bir eklenti bulunmamaktadır.
        </td>
    </tr>
@endforelse

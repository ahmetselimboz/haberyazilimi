            ...
            <div class="col-lg-12 col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Video Ekle</h4>
                    ...
                    <form class="form" action="{{ route('video.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea placeholder="Embed Kodu" name="embed" id="" cols="30" rows="13" class="form-control"></textarea>
                                    </div>
                                </div>
                            </div>

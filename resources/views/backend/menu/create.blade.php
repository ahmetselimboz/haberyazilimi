            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Menü Ekle</h4>
                                                ...
                                                @foreach($categories as $category)
                                                    <div class="d-flex align-items-center mb-10">
                                                        ...
                                                        <span class="addtoright fs-12"
                                                           ...
                                                           data-type="category" data-name="{{$category->title}}" data-id="{{$category->id}}"
                            ...
                            <div class="col-md-8">
                                <div class="bg-primary-light">
                                    <div class="box-header with-border">
                                        ...
                                        <input type="text" name="menu_title" class="form-control w-200 d-inline-block ms-3">
                                    </div>
                                    <div class="box-body">
        ...
        $(function () {
            ...
            $(document).ready(function () {
                ...
                $(".addtoright").click(function (){
                    var url = $(this).data("url"), type = $(this).data("type"), name = $(this).data("name"), id = $(this).data("id");
                ...
                $("#menusave").click(function (){
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            if(response.menu_id !== ''){
                                window.location.href = "menus/"+response.menu_id ;
                            }
                        },

...
@if (isset($design))
    @if ($design == 'default' or $design == 0)
        <header class="mb-4 sticky-top headercolor categorycolor">
            <div class="container">
                <div class="row">
                    <div class="col-12">
...
<footer class="new-footer">
    <div class="container">
        <div class="new-footer-top">
            <div class="new-footer-top-row row">
                <div class="new-footer-titles col-12">Keşfet</div>

                @foreach ($news_groups as $group)
                    <div class="col-md-3">
                        <ul>
                            @foreach ($group as $news)
                                <li class="new-footer-list-elem">
                                    <a
                                        href="{{ route('post', ['categoryslug' => categoryCheck($news['category_id'])->slug, 'slug' => $news['slug'], 'id' => $news['id']]) }}">
                                        {{ $news['title'] }}
                                    </a>
                                </li>
                            @endforeach
    ...
    <div class="new-footer-middle">
        <div class="container">
            <div class="new-footer-titles">Kategoriler</div>
            <div class="new-footer-category-list">

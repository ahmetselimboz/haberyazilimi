...
<head>
    ...
    <!-- Frontend Tema -->
    <link rel="stylesheet" href="{{ asset('lider_bursa/assets/css/bootstrap.css') }}">
    <link rel="stylesheet" href="{{ asset('lider_bursa/assets/css/fonts.css') }}">
    <link rel="stylesheet" href="{{ asset('lider_bursa/assets/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('lider_bursa/assets/css/style-media.css') }}">
    <link rel="stylesheet" href="{{ asset('lider_bursa/assets/css/icons.css') }}">
    <link rel="stylesheet" href="{{ asset('lider_bursa/assets/css/slick.css') }}">
    <link rel="stylesheet" href="{{ asset('lider_bursa/assets/css/slick-theme.css') }}">

     <!-- Tasarım Tema -->
		<link rel="stylesheet" href="{{ asset('lider_bursa/assets/css/yeni.css') }}">
		<link rel="stylesheet" href="{{ asset('lider_bursa/assets/css/font/css/font-awesome.min.css') }}" />
    ...
    <script>!function(){var t=document.createElement("script");t.setAttribute("src",'https://cdn.p.analitik.bik.gov.tr/tracker'+(typeof Intl!=="undefined"?(typeof (Intl||"").PluralRules!=="undefined"?'1':typeof Promise!=="undefined"?'2':typeof MutationObserver!=='undefined'?'3':'4'):'4')+'.js'),t.setAttribute("data-website-id","747cb4ac-4c54-4d8f-9d42-6f138794fa01"),t.setAttribute("data-host-url",'//747cb4ac-4c54-4d8f-9d42-6f138794fa01.collector.p.analitik.bik.gov.tr'),document.head.appendChild(t)}();</script>
...
<body>
	...
	<script type="text/javascript" src="{{ asset('lider_bursa/assets/js/jquery-3.4.1.js') }}"></script>
    <script type="text/javascript" src="{{ asset('lider_bursa/assets/js/jquery.lazyload.js') }}"></script>
    <script type="text/javascript" src="{{ asset('lider_bursa/assets/js/bootstrap.bundle.js') }}"></script>
    <script type="text/javascript" src="{{ asset('lider_bursa/assets/js/jquery.touchSwipe.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('lider_bursa/assets/js/slick.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('lider_bursa/assets/js/script.js') }}"></script>
    <script type="text/javascript" src="{{ asset('lider_bursa/assets/js/script-home.js') }}"></script>
    <script type="text/javascript" src="{{ asset('lider_bursa/assets/js/jquery_cookie.js') }}"></script>
                ...
                <div class="modal-body">
                    ...
                    @else
                        <a href="{{ adsCheck(1)->url }}" class="externallink" title="Reklam 1">
                            <img src="{{ asset(adsCheck(1)->images) }}" alt="Reklam 1" class="img-fluid lazy" data-type="{{ adsCheck(1)->type }}" height="{{ adsCheck(1)->height }}" width="{{ adsCheck(1)->width }}">
                        </a>
                    @endif
                </div>
            </div>

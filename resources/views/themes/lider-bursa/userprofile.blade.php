                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <form method="post" action="{{ route('articlesend') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <label class="form-check-label" for="publish">İleri Tarihte Yayınla </label>
                                                    <div class="form-check form-switch form-switch-md form-check-inline">
                                                    <!-- <label class="form-check-label" for="publish">İleri Tarihte Yayınla</label> -->

                                                        <input class="form-check-input" type="checkbox" id="publish" name="publish" value="1">
                                                        <input type="datetime-local" class="form-control" placeholder="Yayın Tarihi" name="publish_date" id="publish_date"  style="display: none;">
                                                    </div>
                                                </div>
                                            </div>
        ...
        $(document).ready(function() {
            ...
            $('#publish').change(function() {
                if ($(this).is(':checked')) {
                    ...
                    $('#publish_date')
                        .attr('min', getCurrentDateTimeLocal())
                        .show()
                        .attr('required', true);
                } else {
                    $('#publish_date').hide();
                    $('#publish_date')
                        .removeAttr('min').val(''); // Tarih alanını temizle

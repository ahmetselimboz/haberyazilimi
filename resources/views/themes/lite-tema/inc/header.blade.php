        ...
        <div class="container">
            <div class="row">
                <ul class="list-group list-group-horizontal list-unstyled justify-content-center">
                    @if ($routename == 'post')
                        <li class="mx-3 my-1 text-uppercase"><a href="{{ route('post.edit', $post->id) }}"
                                style="color: white;">@lang('frontend.edit')</a></li>
                    @elseif($routename == 'page')
                        <li class="mx-3 my-1 text-uppercase"><a href="{{ route('page.edit', $page->id) }}"
                                style="color: white;">@lang('frontend.edit')</a></li>
                    @endif

                    <li class="mx-3 my-1 text-uppercase"><a href="{{ route('secure.index') }}"
                            style="color: white;">@lang('frontend.management_panel')</a></li>
                    <li class="mx-3 my-1 text-uppercase"><a href="{{ route('userlogout') }}"
                            style="color: white;">@lang('frontend.safe_logout')</a></li>
                </ul>
            </div>
        </div>
    </div>

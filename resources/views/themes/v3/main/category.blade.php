...
@section('content')
    ...
    <div class="row">
		...
		<h2 class="text-black"> @lang('frontend.category_news',$category->title )</h2>
		...
		<div class="col-12 col-md-4">
			...
			<div class="mostly-block overflow-hidden rounded-1 shadow-sm">
				...
				<h2 class="mostly-block-headline mb-4" style="background-color:#ef0000;">@lang('frontend.most_read_news')</h2>
    ...
    <div class="spotlar">
		...
		<h2 class="text-black"> @lang('frontend.category_news_other',$category->title )</h2>

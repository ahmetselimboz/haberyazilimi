...
@php $photo_galleries = \Illuminate\Support\Facades\Storage::disk('public')->json('main/photo_galleries.json'); @endphp
	...
	<h2 class="text-white">@lang('frontend.photo_gallery')</h2>
	<div class="headline-block-indicator"><div class="indicator-ball" style="background-color:#FFF200;"></div></div>
	<a href="{{ route('photo_galleries') }}" class="all-button externallink">@lang('frontend.all')</a>
	</div>
	</div>
...
@else
	...
	<div class="row">
	<div class="alert alert-warning"> @lang('frontend.photo_gallery_not_found') </div>
	</div>
    </div>

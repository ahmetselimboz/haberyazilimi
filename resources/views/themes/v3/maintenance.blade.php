        ...
        <div class="col-md-6">
            <div class="error-template">
                <h1>
                    :) Oops!</h1>
                <h2>
                    @lang('frontend.maintenance_mode_on') </h2>
                <h1>
                     @lang('frontend.well_be_here_shortly') 
                </h1>
                <div>
                ...
                <div class="error-actions">
                    <a href="https://{{$_SERVER['HTTP_HOST']}}" style="margin-top: 10px;" class="btn btn-info btn-lg"><span class="glyphicon glyphicon-home">
                    </span> @lang('frontend.home') </a>
                </div>
            </div>
        </div>
        <div class="col-md-6">

...
@if($magicbox["apiservicestatus"]==0)
    @if($magicbox["currency_status"]==0)
        ...
        @if(isset($magicbox["parapiyasacolor"]))
            <style>
                .bgcolorcustom{ background-color: {{ $magicbox["parapiyasacolor"] }}!important; }
                .currency-block:after{ border-right: 2px solid {{ $magicbox["parapiyasacolor"] }}!important; }
            </style>
        @endif

        @if(isset($magicbox["parapiyasacolortext"]))
            <style>
                .currency-title{ color: {{ $magicbox["parapiyasacolortext"] }}!important; }
            </style>
        @endif
        ...
        <div class="navbar py-0 bg-navbar-black bgcolorcustom">
            <div class="container text-white">
                <div class="row w-100">
                    <div class="col-12 pe-4 position-relative">
                        <div class="currency-slider overflow-hidden d-flex justify-content-start flex-nowrap" id="currencySlider">
                            ...
                            @if(\Illuminate\Support\Facades\Storage::disk('public')->exists('bist.json'))
                                ...
                                @if(isset($bist["result"]) and count($bist["result"])>0)
                                    <div class="currency-block py-2 d-flex flex-nowrap position-relative pe-3 me-3">
                                        <div class="currency-title d-flex flex-nowrap">
                                            BIST 100 <span class="icon-currency-down"></span>
                                        </div>
                                        <div class="currency-parameter">
                                            {{ $bist["result"][0]["current"] }} <span class="d-block text-currency-down">{{ $bist["result"][0]["changeratestr"] }}%</span>
                                        </div>
                                    </div>
                                @endif
                            @endif
                                ...
                                @if(isset($currency["result"]) and count($currency["result"])>0)
                                    <div class="currency-block py-2 d-flex flex-nowrap position-relative pe-3 me-3">
                                        <div class="currency-title d-flex flex-nowrap">
                                            ...
                                            @else<span class="icon-currency-up"></span>@endif
                                        </div>
                                        <div class="currency-parameter">
                                            {{ $currency["result"][0]["buying"] }}
                                            @if(strpos($currency["result"][0]["rate"], "-") !== false)
                                                <span class="d-block text-currency-down">{{ $currency["result"][0]["rate"] }}</span>
                                            @else <span class="d-block text-currency-up">{{ $currency["result"][0]["rate"] }}</span> @endif
                                        </div>
                                    </div>
                                    <div class="currency-block py-2 d-flex flex-nowrap position-relative pe-3 me-3">
                                        <div class="currency-title d-flex flex-nowrap">
                                        ...
                                        <div class="currency-parameter">
                                            ...
                                            @if(strpos($currency["result"][1]["rate"], "-") !== false)
                                                <span class="d-block text-currency-down">{{ $currency["result"][1]["rate"] }}</span>
                                            @else <span class="d-block text-currency-up">{{ $currency["result"][1]["rate"] }}</span> @endif
                                        </div>
                                    </div>
                                    <div class="currency-block py-2 d-flex flex-nowrap position-relative pe-3 me-3">
                                        <div class="currency-title d-flex flex-nowrap">
                                        ...
                                        <div class="currency-parameter">
                                            ...
                                            @if(strpos($currency["result"][2]["rate"], "-") !== false)
                                                <span class="d-block text-currency-down">{{ $currency["result"][2]["rate"] }}</span>
                                            @else <span class="d-block text-currency-up">{{ $currency["result"][2]["rate"] }}</span> @endif
                                        </div>
                                    </div>
                                    <div class="currency-block py-2 d-flex flex-nowrap position-relative pe-3 me-3">
                                        <div class="currency-title d-flex flex-nowrap">
                                        ...
                                        <div class="currency-parameter">
                                            ...
                                            @if(strpos($currency["result"][5]["rate"], "-") !== false)
                                                <span class="d-block text-currency-down">{{ $currency["result"][5]["rate"] }}</span>
                                            @else <span class="d-block text-currency-up">{{ $currency["result"][5]["rate"] }}</span> @endif
                                        </div>
                                    </div>
                                @endif
                            @endif
                                ...
                                @if(isset($gold["result"]) and count($gold["result"])>0)
                                    <div class="currency-block py-2 d-flex flex-nowrap position-relative pe-3 me-3">
                                        ...
                                        <div class="currency-parameter">
                                            ...
                                            @if(strpos($gold["result"][0]["rate"], "-") !== false)
                                                <span class="d-block text-currency-down">{{ $gold["result"][0]["rate"] }}</span>
                                            @else <span class="d-block text-currency-up">{{ $gold["result"][0]["rate"] }}</span> @endif
                                        </div>
                                    </div>
                                    <div class="currency-block py-2 d-flex flex-nowrap position-relative pe-3 me-3">
                                        <div class="currency-title d-flex flex-nowrap">
                                        ...
                                        <div class="currency-parameter">
                                            ...
                                            @if(strpos($gold["result"][20]["rate"], "-") !== false)
                                                <span class="d-block text-currency-down">{{ $gold["result"][20]["rate"] }}</span>
                                            @else <span class="d-block text-currency-up">{{ $gold["result"][20]["rate"] }}</span> @endif
                                        </div>
                                    </div>
                                @endif
                            @endif
                                ...
                                @if(isset($coin["result"]))
                                    <div class="currency-block py-2 d-flex flex-nowrap position-relative pe-3 me-3">
                                        ...
                                        <div class="currency-parameter">
                                            ...
                                            @if(strpos($coin["result"][0]["changeDay"], "-") !== false)
                                                <span class="d-block text-currency-down">{{ $coin["result"][0]["changeDay"] }}</span>
                                            @else <span class="d-block text-currency-up">{{ $coin["result"][0]["changeDay"] }}</span> @endif
                                        </div>
                                    </div>
                                @endif
                            @endif
...
@else
    <div class="container">
        <div class="row">
            <div class="alert alert-warning"> API servisi kapalı </div>
        </div>
    </div>
@endif

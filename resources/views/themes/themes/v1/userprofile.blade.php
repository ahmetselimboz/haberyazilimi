                                            ...
                                            @foreach($articles as $article)
                                                <li>
                                                    @if($article->publish==0)
                                                        <a href="{{ route('article',['slug'=>$article->slug,'id'=>$article->id]) }}" class="externallink">{{$article->title}}</a>
                                                        <span class="btn btn-sm btn-success" style="font-size: 8px;">ONAYLI</span>
                                                    @else
                                                        {{$article->title}}
                                                        <span class="badge badge-warning" style="font-size: 8px;">ONAY BEKLİYOR</span>
                                                        <span class="btn btn-sm btn-info" style="font-size: 8px;">DÜZENLE</span>
                                                    @endif
                                                </li>
                                            @endforeach
                                        </ul>

        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-5">
                <div class="video-detail-headline mb-4" id="detailContent">
                    <h2 class="video-detail-title">{{ html_entity_decode(html_entity_decode($video_gallery->title)) }}</h2>
                    <p class="video-detail-desc">{!! html_entity_decode($video_gallery->detail) !!}</p>
                </div>
                ...
                <div class="video-detail-footer">
                    <div class="d-flex justify-content-start">
                        <div class="detail-author-block mb-4 d-none">
                            ...
                            <div class="text-truncate">Metin Şiphani</div>
                        </div>
...
<div class="container">
    <div class="row">
        @foreach($other_videos as $other_video)
            <div class="col-6 col-md-4 col-lg-2 mb-4"><!-- (Video Kartı) -->
                <div class="card overflow-hidden rounded-1 border-0 shadow-sm">
                    <a href="@if($other_video->category!=null) {{ route('video_gallery', ['categoryslug'=>$other_video->category->slug,'slug'=>$other_video->slug,'id'=>$other_video->id]) }} @endif" title="{{ html_entity_decode($other_video->title) }}" class="externallink">
                        <img src="
                        {{ route('resizeImage', ["i_url" => imageCheck($other_video->images), "w" => 179, "h" => 119]) }}

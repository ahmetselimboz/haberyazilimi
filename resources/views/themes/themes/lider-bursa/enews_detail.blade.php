    ...
    <script type="text/javascript">
        ...
        function addPage(page, book) {
            if (!book.turn('hasPage', page)) {
                var element = $('<div />', {
                    ...
                    'id': 'page-' + page
                }).html('<div class="page "><div class="loading-container"><div class="loading-spinner"></div><div class="loading-text">Yükleniyor...</div></div></div>');
        ...
        $(window).resize(function() {
          ...
          function mobilecheck() {
            ...
            return /android|webos|iphone|ipad|ipod|blackberry|iemobile|opera mini|windows phone/i.test(userAgent);
        }
    </script>
